...
open class iProgressHUD {
    ...
    open var indicatorStyle: NVActivityIndicatorType = .ballRotateChase
    ...
    open var indicatorSize: CGFloat = 20
    /** Setting the alpha of modal view. Default is 0.7 */
    open var alphaModal: CGFloat = 0.2
